...
encode_iter(Custom_model *custom_model, GtkTreeIter *iter, value v)
{
  ...
  /* Ideally, the user would already have ensured all these were stable...
    ...
    if((Is_block(v1) && (char*)v1 < (char*)Caml_state_field(young_end) && (char*)v1 > (char*)Caml_state_field(young_start)) ||
       (Is_block(v2) && (char*)v2 < (char*)Caml_state_field(young_end) && (char*)v2 > (char*)Caml_state_field(young_start)) ||
       (Is_block(v3) && (char*)v3 < (char*)Caml_state_field(young_end) && (char*)v3 > (char*)Caml_state_field(young_start)))
      {
							...
							value callback_object)
{
  ...
  if(Is_block(callback_object) &&
      (char*)callback_object < (char*)Caml_state_field(young_end) &&
      (char*)callback_object > (char*)Caml_state_field(young_start))
    {
